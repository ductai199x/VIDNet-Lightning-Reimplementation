...
def get_args():
    ...
    parser.add_argument("--dataset", "-o", metavar="INPUT", help="filenames of ouput images")
    parser.add_argument("--mask_dir", "-d", metavar="mask", help="filenames of ouput images")
    parser.add_argument("--im_dir", "-l", metavar="mask", help="filenames of ouput images")
...
if __name__ == "__main__":
    ...
    for i, fn in enumerate(in_files):
        ...
        result = scipy.misc.imread(
            os.path.join(args.input, fn.split("/")[-2], file_name + "_instance_00.png"), "L"
        )
