...
def get_parser():
    ...
    parser.add_argument(
        ...
        dest="resume",
        action="store_true",
        help=("whether to resume training an existing model " "(the one with name model_name will be used)"),
    )
    ...
    parser.add_argument(
        ...
        type=int,
        help=(
            "set epoch_resume if you want flags "
    ...
    parser.add_argument(
        ...
        type=int,
        help=(
            "epoch number to start finetuning. set -1 to not finetune."
    ...
    parser.add_argument(
        ...
        type=int,
        help=(
            "patience term to activate flags such as "
            "use_class_loss, feed_prediction and update_encoder if "
            "their matching vars are not -1"
        ),
    )
    parser.add_argument(
        "-patience_stop", dest="patience_stop", default=60, type=int, help="patience to stop training."
    )
    ...
    parser.add_argument(
        "-skip_mode", dest="skip_mode", default="concat", choices=["sum", "concat", "mul", "none"]
    )
    ...
    parser.add_argument(
        "-dataset", dest="dataset", default="davis2016", choices=["davis2016_vi", "davis2016", "davis2017"]
    )
    ...
    # demo
    parser.add_argument(
        "-frames_path", dest="frames_path", default="../databases/DAVIS2017/JPEGImages/480p/tennis-vest"
    )
    parser.add_argument(
        "-mask_path",
        dest="init_mask_path",
        default="../databases/DAVIS2017/Annotations/480p/tennis-vest/00000.png",
    )
